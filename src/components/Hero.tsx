  ...
  return (
    <section id="top" className="relative min-h-screen flex flex-col items-center justify-start md:justify-center pt-28 md:pt-20 overflow-hidden">
      ...
      <div className="relative w-full max-w-7xl px-6 flex flex-col items-center">
        ...
        <div className="md:hidden mt-20 flex flex-col items-center gap-3 text-center">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="hidden mt-72 md:mt-[18rem] w-full relative z-30 max-w-7xl md:flex md:flex-row items-center justify-center min-h-[120px]">
          <motion.div 
